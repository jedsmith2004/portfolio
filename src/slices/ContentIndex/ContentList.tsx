...
export default function ContentList({
    ...
    useEffect(() => {
      ...
      const contentImages = items.map((item)=>{
          const image = isFilled.image(item.data.hover_image) ? item.data.
          hover_image : fallbackItemImage;
...
{/* Hover Element */}
<div className="hover-reveal pointer-events-none absolute left-0 top-0 -z-10 h-[320px] w-[220px] *:
rounded-lg bg-over bg-center opacity-0 transition-[background] duration-300"
  style={{
